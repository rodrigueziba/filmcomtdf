                ...
                <div class="card-header">
				    ...
				    <div id="collapseThree1" class="collapse" aria-labelledby="headingThree1" data-parent="#accordion">
				      <div class="card-body">
				        @foreach ($clases as $clase1)
					      	<a href="{{ route('clase.show', $clase1->id ) }}" class="badge badge-secondary">{{ $clase1->nombre }} </a>
				  ...
				  <div class="card">
				    ...
				    <div id="collapseThree12" class="collapse" aria-labelledby="headingThree12" data-parent="#accordion">
				      <div class="card-body">
				        @foreach ($alquileres as $alquiler1)
					      	<a href="{{ route('alquiler.show', $alquiler1->id ) }}" class="badge badge-secondary">{{ $alquiler1->nombre }} </a>
            ...
            <div class="card ">
             ...
             <div class="card-body">
             	...
             	<div class="card-deck">
					  ...
					  @foreach ($clase->perfilproductoras as $perfil)
					  ...
					  <div class="card text-center"  style="min-width: 45%; max-width: 45%; margin-top: 10px; justify-content-center;min-height:40%; max-height:40%;">
					    ...
					    <div class="card-body">
					      ...
					      <p>
					      	@foreach ($perfil->clases as $items)
					       	<a href="{{ route('clase.show', $items->id ) }}" class="badge badge-secondary">{{ $items->nombre }}</a> 
					       @endforeach 
					      	</p>
					      	<p class="card-text"> 
