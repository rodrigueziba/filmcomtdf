				    ...
				    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
				      <div class="card-body">
				         @foreach ($areas as $items)
					      	<a href="{{ route('area.show', $items->id ) }}" class="badge badge-dark">{{ $items->nombre }} </a>
				    ...
				    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
				      <div class="card-body">
				        @foreach ($idiomas as $item)
					      	<a href="{{ route('idioma.show', $item->id ) }}" class="badge badge-secondary">{{ $item->nombre }} </a>
            ...
            <div class="card ">
             ...
             <div class="card-body">
             	...
             	<div class="card-deck">
					  ...
					  @foreach ($idioma->perfilprofesional as $perfil)
