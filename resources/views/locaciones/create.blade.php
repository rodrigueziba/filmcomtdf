        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h1 style="justify:center"> Registro | <strong>  Locación</strong></h1>
                        </div>
          ...
          <div class="row">
            <div class="col-md-8 offset-md-2">
              <form method="POST" action="{{ route('locaciones.store') }}" enctype= "multipart/form-data">
                @csrf
...
<div id="address-map-container" style="width:100%;height:400px; ">
    <div style="width: 100%; height: 100%" id="address-map"></div>
                ...
                <div class="form-group">
                  ...
                  <select multiple class="form-control " name="categoria_id[]"  multiple="multiple" >
